-- Create 7 new fake user profiles with properly formatted UUIDs
INSERT INTO auth.users (
  ...
  ('a1111111-1111-1111-1111-11111111111a', 'emma.travel@example.com', crypt('password123', gen_salt('bf')), now(), now(), now(), '{"display_name": "Emma Travel"}', 'authenticated', 'authenticated'),
  ('b2222222-2222-2222-2222-22222222222b', 'marco.food@example.com', crypt('password123', gen_salt('bf')), now(), now(), now(), '{"display_name": "Marco Food"}', 'authenticated', 'authenticated'),
  ('c3333333-3333-3333-3333-33333333333c', 'sophie.photo@example.com', crypt('password123', gen_salt('bf')), now(), now(), now(), '{"display_name": "Sophie Photo"}', 'authenticated', 'authenticated'),
  ('d4444444-4444-4444-4444-44444444444d', 'james.adventure@example.com', crypt('password123', gen_salt('bf')), now(), now(), now(), '{"display_name": "James Adventure"}', 'authenticated', 'authenticated'),
  ('e5555555-5555-5555-5555-55555555555e', 'lucia.arch@example.com', crypt('password123', gen_salt('bf')), now(), now(), now(), '{"display_name": "Lucia Arch"}', 'authenticated', 'authenticated'),
  ('f6666666-6666-6666-6666-66666666666f', 'thomas.nomad@example.com', crypt('password123', gen_salt('bf')), now(), now(), now(), '{"display_name": "Thomas Nomad"}', 'authenticated', 'authenticated'),
  ('a7777777-7777-7777-7777-77777777777a', 'olivia.wine@example.com', crypt('password123', gen_salt('bf')), now(), now(), now(), '{"display_name": "Olivia Wine"}', 'authenticated', 'authenticated');
...
INSERT INTO user_profiles (
  ...
  ('a1111111-1111-1111-1111-11111111111a', 'emma.travel@example.com', 'Emma Travel', 'https://images.unsplash.com/photo-1494790108755-2616b9c9b4b5', 'Art lover exploring Renaissance treasures', now(), now()),
  ('b2222222-2222-2222-2222-22222222222b', 'marco.food@example.com', 'Marco Food', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d', 'Culinary explorer discovering Italian flavors', now(), now()),
  ('c3333333-3333-3333-3333-33333333333c', 'sophie.photo@example.com', 'Sophie Photo', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80', 'Photographer capturing European beauty', now(), now()),
  ('d4444444-4444-4444-4444-44444444444d', 'james.adventure@example.com', 'James Adventure', 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e', 'Thrill seeker conquering Alpine peaks', now(), now()),
  ('e5555555-5555-5555-5555-55555555555e', 'lucia.arch@example.com', 'Lucia Arch', 'https://images.unsplash.com/photo-1544005313-94ddf0286df2', 'Architecture enthusiast studying Swiss design', now(), now()),
  ('f6666666-6666-6666-6666-66666666666f', 'thomas.nomad@example.com', 'Thomas Nomad', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e', 'Digital nomad working from scenic locations', now(), now()),
  ('a7777777-7777-7777-7777-77777777777a', 'olivia.wine@example.com', 'Olivia Wine', 'https://images.unsplash.com/photo-1534528741775-53994a69daeb', 'Sommelier exploring European wine regions', now(), now());
...
INSERT INTO retrospectives (
  ...
  ('fa111111-1111-1111-1111-11111111111a', 'a1111111-1111-1111-1111-11111111111a', 'Renaissance Magic in Florence', '2024-08-15', 'vacation', 'Florence Historic Center', 'Florence', 'Tuscany', 'Italy', 43.7696, 11.2558, false,
   '[
  ...
  ('fb222222-2222-2222-2222-22222222222b', 'b2222222-2222-2222-2222-22222222222b', 'Tuscan Culinary Journey', '2024-07-20', 'food_tour', 'Mercato Centrale', 'Florence', 'Tuscany', 'Italy', 43.7648, 11.2594, false,
   '[
  ...
  ('fc333333-3333-3333-3333-33333333333c', 'c3333333-3333-3333-3333-33333333333c', 'Florence Through the Lens', '2024-09-05', 'photography', 'Ponte Vecchio', 'Florence', 'Tuscany', 'Italy', 43.7678, 11.2530, false,
   '[
...
INSERT INTO retrospectives (
  ...
  ('ld444444-4444-4444-4444-44444444444d', 'd4444444-4444-4444-4444-44444444444d', 'Swiss Alpine Thrills', '2024-08-10', 'adventure', 'Mount Pilatus', 'Lucerne', 'Central Switzerland', 'Switzerland', 46.9481, 8.3369, false,
   '[
  ...
  ('le555555-5555-5555-5555-55555555555e', 'e5555555-5555-5555-5555-55555555555e', 'Swiss Architecture Deep Dive', '2024-07-25', 'education', 'Chapel Bridge', 'Lucerne', 'Central Switzerland', 'Switzerland', 46.9529, 8.3089, false,
   '[
  ...
  ('lf666666-6666-6666-6666-66666666666f', 'f6666666-6666-6666-6666-66666666666f', 'Remote Work Swiss Style', '2024-08-30', 'business', 'Lucerne Old Town', 'Lucerne', 'Central Switzerland', 'Switzerland', 46.9481, 8.3089, false,
   '[
  ...
  ('la777777-7777-7777-7777-77777777777a', 'a7777777-7777-7777-7777-77777777777a', 'Swiss Wine Discovery', '2024-09-12', 'cultural', 'Lake Lucerne Vineyards', 'Lucerne', 'Central Switzerland', 'Switzerland', 46.9529, 8.3089, false,
   '[
...
INSERT INTO activities (
  ...
  ('a1111111-1111-1111-1111-11111111111a', 'rose_added', 'fa111111-1111-1111-1111-11111111111a', 'retrospective', '{"title": "Renaissance Magic in Florence", "count": 3}'),
  ('b2222222-2222-2222-2222-22222222222b', 'bud_added', 'fb222222-2222-2222-2222-22222222222b', 'retrospective', '{"title": "Tuscan Culinary Journey", "count": 2}'),
  ('c3333333-3333-3333-3333-33333333333c', 'thorn_added', 'fc333333-3333-3333-3333-33333333333c', 'retrospective', '{"title": "Florence Through the Lens", "count": 2}'),
  ('d4444444-4444-4444-4444-44444444444d', 'rose_added', 'ld444444-4444-4444-4444-44444444444d', 'retrospective', '{"title": "Swiss Alpine Thrills", "count": 4}'),
  ('e5555555-5555-5555-5555-55555555555e', 'bud_added', 'le555555-5555-5555-5555-55555555555e', 'retrospective', '{"title": "Swiss Architecture Deep Dive", "count": 2}'),
  ('f6666666-6666-6666-6666-66666666666f', 'thorn_added', 'lf666666-6666-6666-6666-66666666666f', 'retrospective', '{"title": "Remote Work Swiss Style", "count": 2}'),
  ('a7777777-7777-7777-7777-77777777777a', 'rose_added', 'la777777-7777-7777-7777-77777777777a', 'retrospective', '{"title": "Swiss Wine Discovery", "count": 3}');

-- Create friendships for better feed interaction
INSERT INTO friendships (user_id, friend_id, status) VALUES 
  ('a1111111-1111-1111-1111-11111111111a', 'b2222222-2222-2222-2222-22222222222b', 'accepted'),
  ('a1111111-1111-1111-1111-11111111111a', 'c3333333-3333-3333-3333-33333333333c', 'accepted'),
  ('b2222222-2222-2222-2222-22222222222b', 'd4444444-4444-4444-4444-44444444444d', 'accepted'),
  ('c3333333-3333-3333-3333-33333333333c', 'e5555555-5555-5555-5555-55555555555e', 'accepted'),
  ('d4444444-4444-4444-4444-44444444444d', 'f6666666-6666-6666-6666-66666666666f', 'accepted'),
  ('e5555555-5555-5555-5555-55555555555e', 'a7777777-7777-7777-7777-77777777777a', 'accepted'),
  ('f6666666-6666-6666-6666-66666666666f', 'a1111111-1111-1111-1111-11111111111a', 'accepted'),
  ('a7777777-7777-7777-7777-77777777777a', 'b2222222-2222-2222-2222-22222222222b', 'accepted');